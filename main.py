{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOItOBnsiiu0A/KqRVQwUGQ",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/naimadmpi10/repository-/blob/main/main.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      "source": [
        ...
        "!pip install flask flask-ngrok pydub ffmpeg-python\n",
        "!apt-get update\n",
        ...
        "    text = result[\"text\"]\n",
        "\n",
        "    # Translate text to Bengali using Deep Translator\n",
        "    translated_text = GoogleTranslator(source='auto', target='bn').translate(text)\n",
        "\n",
        ...
        "    app.run(port=5000)\n",
        "\n",
        "# Install ngrok and set up the token\n",
        "!wget -q -nc https://bin.equinox.io/c/bNyj1mQVY4c/ngrok-stable-linux-amd64.zip\n",
        "!unzip -o ngrok-stable-linux-amd64.zip\n",
        "!mv -f ngrok /usr/local/bin\n",
        "\n",
        "# Set ngrok auth token (only once needed)\n",
        "!ngrok config add-authtoken 2wAdb14fQ9S9aXgcAfb9eNf9fVG_5KRft9aW4XpseC4YcFzsE\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "9DNnIk-R6jYL",
        "outputId": "a3d749d4-d1a5-427b-da91-2894230a0bba"
      },
      "execution_count": 1,
      "outputs": [
        {
          ...
          "text": [
            ...
            "Installing collected packages: pydub, ffmpeg-python, flask-ngrok\n",
            "Successfully installed ffmpeg-python-0.2.0 flask-ngrok-0.0.25 pydub-0.25.1\n",
            ...
            "Fetched 18.3 MB in 4s (4,826 kB/s)\n",
            ...
            "  Cloning https://github.com/openai/whisper.git to /tmp/pip-req-build-rzvkdrh1\n",
            "  Running command git clone --filter=blob:none --quiet https://github.com/openai/whisper.git /tmp/pip-req-build-rzvkdrh1\n",
            ...
            "  Created wheel for openai-whisper: filename=openai_whisper-20240930-py3-none-any.whl size=803706 sha256=3daa39766e8ac3985ede6a50cdf509ceefb6f1611823ec76c680f14af6040e06\n",
            "  Stored in directory: /tmp/pip-ephem-wheel-cache-r0hree76/wheels/1f/1d/98/9583695e6695a6ac0ad42d87511097dce5ba486647dbfecb0e\n",
        ...
        },
        {
          ...
          "name": "stdout",
          "text": [
            "Public URL: https://a9e5-35-204-80-167.ngrok-free.app\n"
          ]
        }
      ]
    }
